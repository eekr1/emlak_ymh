...
export function buildRunInstructions(brandKey, brandCfg = {}) {
    ...
    return [
        ...
        ``,
        `KRİTİK HATA YAPMA:`,
        `- Bu 4 temel bilgi (Kim? Ne? Nerede? Ne Kadar?) haricinde EKSTRA DETAY SORMA.`,
        `- Kat, cephe, manzara, site içi vb. detayları sorma. Bunları satış danışmanı telefonda konuşacak.`,
        `- Sadece yukarıdaki 4 madde tamamsa HEMEN handoff yap.`,
        ``,
        `ÖNEMLİ KURAL:`,
